function abcloak(site,iconurl,title) { // ab (about:blank) cloaking stops websites from being shown in history, this also lets you change the site it tries to looklike 
    win = window.open();
